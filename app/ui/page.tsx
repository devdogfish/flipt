...
import {
  QrCode, RefreshCw, X, Sun, Flame, Volume2, Timer, Copy,
  MapPin, ChevronLeft, ChevronRight, Bug, Moon, Zap, Battery,
  Link2, CreditCard, Landmark, Music, Instagram, Globe,
  MoreHorizontal, Check, Plus, Search, Waves,
} from 'lucide-react'
...
// ── Mini bar chart ────────────────────────────────────────────────────────────
function MiniBar({ values, className }: { values: number[]; className?: string }) {
  ...
  return (
    <div className="relative flex items-center justify-center">
      <svg viewBox="0 0 100 100" className="size-36 -rotate-90">
        <circle cx="50" cy="50" r={r} fill="none" stroke="currentColor" strokeWidth="11" className="text-muted/40" />
        <circle
...
// ── Mini stock row ────────────────────────────────────────────────────────────
function StockRow({ ticker, shares, value, bars }: { ticker: string; shares: string; value: string; bars: number[] }) {
  return (
    <div className="flex items-center gap-3">
      ...
      <span className="text-sm font-mono font-medium w-20 text-right">{value}</span>
    </div>
  )
}

export default function UIPage() {
  const [date, setDate] = React.useState<Date | undefined>(new Date(2026, 3, 7))
      ...
      <div style={{ columns: '310px', columnGap: '1rem' }}>
        ...
        <Card className="break-inside-avoid mb-4">
          <CardContent className="flex flex-col items-center gap-3 py-6 text-center">
            ...
            <div>
              <p className="font-semibold text-sm">Scan to connect your mobile device</p>
              <p className="text-xs text-muted-foreground mt-1 max-w-[220px]">Open the app and scan this code to link your device.</p>
            </div>
        ...
        <Card className="break-inside-avoid mb-4">
          <CardHeader>
            <div className="flex items-start justify-between">
              <div>
                ...
                <CardDescription className="mt-1">Quarterly dividend payouts across your portfolio holdings.</CardDescription>
              </div>
          ...
          <CardContent>
            <div className="flex flex-col gap-4">
              <StockRow ticker="Vanguard VIG" shares="450 Shares" value="$1,842.10" bars={[4,5,3,6,5,7,6,8,7,9]} />
              <StockRow ticker="S&P 500 VOO" shares="112 Shares" value="$928.40" bars={[3,4,4,5,3,6,5,6,7,7]} />
              <StockRow ticker="Apple AAPL" shares="85 Shares" value="$340.00" bars={[2,3,2,4,3,4,5,4,6,5]} />
              <StockRow ticker="Realty Income" shares="320 Shares" value="$1,139.50" bars={[5,4,6,5,7,6,8,7,9,8]} />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="break-inside-avoid mb-4">
          <CardContent className="flex flex-col items-center gap-3 py-8 text-center">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">We're pulling in your latest transactions.<br />This usually takes a few seconds.</p>
            </div>
          ...
          <CardHeader>
            <div className="flex items-start justify-between">
              <div>
                ...
                <CardDescription className="mt-1">Manage your account settings and notifications.</CardDescription>
              </div>
              <Button variant="ghost" size="icon-sm"><X className="size-4" /></Button>
            </div>
          </CardHeader>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">Allow others to see your total stream count and listening activity.</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">Monthly royalty reports and distribution updates.</p>
                </div>
                <Switch defaultChecked />
              </div>
            </div>
          ...
          <CardHeader>
            <div className="flex items-start justify-between">
              <div>
                ...
                <CardDescription className="mt-1">Move money between your connected accounts.</CardDescription>
              </div>
              <Button variant="ghost" size="icon-sm"><X className="size-4" /></Button>
            </div>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 text-sm">
                ...
                <div className="flex justify-between"><span className="text-muted-foreground">Total amount</span><span className="font-semibold">$1,200.00</span></div>
              </div>
            </div>
          </CardContent>
          <CardFooter>
        ...
        <Card className="break-inside-avoid mb-4">
          ...
          <CardContent>
            <div className="flex flex-col gap-4">
              <MiniBar values={[3,5,7,6,8,7,9,10,9,11,10,12,10,8,9,8]} className="h-24 w-full" />
        ...
        <Card className="break-inside-avoid mb-4">
          <CardContent className="flex flex-col items-center gap-3 py-8 text-center">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1 max-w-[220px]">Link your payout method to receive monthly royalty distributions automatically.</p>
            </div>
        ...
        <Card className="break-inside-avoid mb-4">
          ...
          <CardContent>
            <div className="flex flex-col gap-3">
              {[
                { label: 'Spotify Artist URL', icon: Music, placeholder: 'spotify.com/artist/3j...2k' },
                { label: 'Instagram Handle', icon: Instagram, placeholder: '@julianduryea_music' },
                { label: 'SoundCloud URL', icon: Waves, placeholder: 'soundcloud.com/username' },
                { label: 'Website', icon: Globe, placeholder: 'https://yoursite.com' },
        ...
        <Card className="break-inside-avoid mb-4">
          ...
          <CardContent>
            <div className="flex flex-col gap-3">
              ...
              <Button variant="outline" size="sm"><Plus />Add another</Button>
              <Separator />
              <div className="flex flex-col gap-1.5">
                <Label>Or share invite link</Label>
                <div className="flex gap-2">
                  <Input defaultValue="https://app.co/invite/x8f2k" readOnly className="flex-1 text-muted-foreground" />
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-4 gap-2">
                {['9:00 AM', '10:30 AM', '11:00 AM', '1:30 PM'].map((t) => (
                  <Button key={t} variant={t === '10:30 AM' ? 'default' : 'outline'} size="sm" className="text-xs px-2">
                    {t}
                  </Button>
                ))}
              </div>
              <div className="flex items-start gap-2 rounded-lg border p-3">
                ...
                <div>
                  <Label htmlFor="new-patient" className="text-sm font-medium">New patient?</Label>
          ...
          <CardContent>
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-muted-foreground mt-1">Your name may appear around the app where you contribute or are mentioned.</p>
              </div>
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-muted-foreground mt-1">You can manage verified email addresses in your email settings.</p>
              </div>
              <div className="flex flex-col gap-1">
                <Label>Bio</Label>
        ...
        <Card className="break-inside-avoid mb-4">
          <CardContent className="flex flex-col items-center gap-3 py-8 text-center">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">Invite your team to collaborate on this project.</p>
            </div>
        ...
        <Card className="break-inside-avoid mb-4">
          ...
          <CardContent>
            <div className="flex flex-col gap-4">
              <MiniBar values={[4,6,8,9,7,8,10,9,7,8,6,5,7,8,9,8]} className="h-20 w-full" />
              <div className="grid grid-cols-4 gap-2 text-center text-xs">
                {[{ label: 'Deep', val: '2h 10m' }, { label: 'Light', val: '3h 48m' }, { label: 'REM', val: '1h 26m' }, { label: 'Score', val: '84' }].map((s) => (
                  <div key={s.label}>
